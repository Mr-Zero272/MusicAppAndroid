...
public class SongsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        musicAdapter = new MusicAdapter(getContext());
        // vi tab song hien thi toan bo bai hat cua thiet bi cung chinh la toan bo bai hat trong album device albumid 1
        ArrayList<MusicFiles> musicFiles = musicAdapter.ListAllMusicFile(1);
